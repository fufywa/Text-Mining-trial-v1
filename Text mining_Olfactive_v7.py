...
def stretch_scores(scores: list, low: float = 20.0, high: float = 90.0) -> list:
    ...
    If all scores are identical, returns midpoint for all.
    """
...
if "processed_df" in st.session_state:
    ...
    with tab2:
        ...
        st.caption(
            ...
            "Scores are stretched to 20–90% to maximise visual spread while "
            "preserving relative ranking — use them to track iteration direction, "
            "not as absolute similarity values."
        )
        ...
        if cand_sel:
            ...
            ax_bar.set_xlabel("Similarity to reference (stretched 20–90%)")
